...
function orvsd_process_css($css, $theme) {
    ...
    $css = orvsd_set_menubackcolor($css, $menubackcolor);
    ...
    $css = orvsd_set_menuhovercolor($css, $menuhovercolor);
    ...
    $css = orvsd_set_backimage($css, $backimage);
    ...
    $css = orvsd_set_backposition($css,$backposition);
    ...
    $css = orvsd_set_backcolor($css, $backcolor);
    ...
    $css = orvsd_set_customcss($css, $customcss);
    
    return $css;
}

function orvsd_set_menubackcolor($css, $menubackcolor) {
...
function orvsd_set_menuhovercolor($css, $menuhovercolor) {
...
function orvsd_set_backimage($css, $backimage) {
	global $OUTPUT;  
...
function orvsd_set_backposition($css, $backposition = 'no-repeat', $tag = '[[setting:backposition]]'){
...
function orvsd_set_backcolor($css, $backcolor) {
...
function orvsd_set_logo($css, $logo) {
	global $OUTPUT;  
	$tag = '[[setting:logo]]';
	$replacement = $logo;
	$css = str_replace($tag, $replacement, $css);
...
function orvsd_set_customcss($css, $customcss) {
