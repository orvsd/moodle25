...
class theme_bootstrapthelmsapp_core_renderer extends core_renderer {
    ...
    protected function render_custom_menu(custom_menu $menu) {
        ...
        if (is_siteadmin($USER)) {
            $menu->add(get_string('purgecaches', 'theme_bootstrapthelmsapp'), new moodle_url('/admin/purgecaches.php', array('sesskey' =>  sesskey(), 'confirm' => '1')), null, $menupos++);
        }
